...
const dict = {
  zh: {
    ...
    edit_region: "局部编辑",
    brand_kit: "品牌套件",
    brand_kit_title: "设一次品牌规范，整套生成自动统一",
    brand_kit_desc: "设定品牌色/字体/调性，激活后 AI 生成的每张图都会遵循，保持整套一致。",
    brand_name: "品牌名",
    brand_name_ph: "如：暖山家居",
    brand_colors: "品牌配色",
    brand_primary: "主色",
    brand_add_accent: "加辅助色",
    brand_font: "字体气质",
    brand_font_ph: "如：圆润无衬线 / 手写体 / 衬线优雅",
    brand_slogan: "品牌调性 / Slogan",
    brand_slogan_ph: "如：慢生活，好物相伴",
    brand_active: "启用品牌规范",
    brand_active_hint: "开启后，生成时自动注入以上品牌规范；关闭则不影响。",
    save: "保存",
    saving: "保存中…",
    brand_saved: "品牌套件已保存",
    brand_save_failed: "保存失败，请重试",
    skill_remove: "移除物体",
    skill_mockup: "场景合成",
    skill_outpaint: "扩图",
    skill_need_one: "请只选中一张图片",
    skill_failed: "操作失败，请重试",
    mask_remove_title: "涂抹要移除的物体",
    mask_remove_cta: "移除",
    credits_label: (cr) => `${cr} 积分`,
    mk_tshirt: "T恤", mk_mug: "马克杯", mk_phone: "手机壳", mk_tote: "帆布袋",
    mk_poster: "装裱海报", mk_box: "包装盒", mk_sign: "店招",
    ar_square: "方形 1:1", ar_landscape: "横屏 16:9", ar_portrait: "竖屏 9:16",
    ar_34: "竖版 3:4", ar_43: "横版 4:3",
  ...
  en: {
    ...
    brand_kit: "Brand kit",
    brand_kit_title: "Set your brand once — every design stays consistent",
    brand_kit_desc: "Define brand colors/font/tone. Once active, every AI design follows it for a consistent set.",
    brand_name: "Brand name",
    brand_name_ph: "e.g. Warm Hill Home",
    brand_colors: "Brand colors",
    brand_primary: "Primary",
    brand_add_accent: "Add accent",
    brand_font: "Font style",
    brand_font_ph: "e.g. rounded sans / handwritten / elegant serif",
    brand_slogan: "Tone / Slogan",
    brand_slogan_ph: "e.g. Slow living, good things",
    brand_active: "Enable brand kit",
    brand_active_hint: "When on, the brand rules are injected into every generation.",
    save: "Save",
    saving: "Saving…",
    brand_saved: "Brand kit saved",
    brand_save_failed: "Save failed, please retry",
    skill_remove: "Remove object",
    skill_mockup: "Mockup",
    skill_outpaint: "Expand",
    skill_need_one: "Select exactly one image",
    skill_failed: "Failed, please retry",
    mask_remove_title: "Paint the object to remove",
    mask_remove_cta: "Remove",
    credits_label: (cr) => `${cr} credits`,
    mk_tshirt: "T-shirt", mk_mug: "Mug", mk_phone: "Phone case", mk_tote: "Tote bag",
    mk_poster: "Framed poster", mk_box: "Package box", mk_sign: "Store sign",
    ar_square: "Square 1:1", ar_landscape: "Landscape 16:9", ar_portrait: "Portrait 9:16",
    ar_34: "Portrait 3:4", ar_43: "Landscape 4:3",
